<?php echo $header ?>
    <section class="content">
        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" class="form-horizontal" id="form-size">
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">Danh sách kích cỡ sản phẩm</h3>
                </div>
                <div class="box-body">
                    <table class="table table-bordered">
                        ...
                        <?php foreach ($sizes as $size) {?>
                            <tr>
                                ...
                                <td class="text-right">
                                    <a href="<?php echo $size['edit'] ?>" class="btn btn-primary"><i class="fa fa-edit"></i>&nbsp;Sửa </a>
                                </td>
                            </tr>
                        <?php }?>
                        </tbody>
