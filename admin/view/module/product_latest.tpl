                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="product_latest_module[limit]" id="input-limit" value="<?php echo isset($module['limit']) ? $module['limit'] : '4'; ?>" class="form-control" placeholder="Giới hạn"/>
                                </div>
                            </div>
                            <hr/>
                            <div class="form-group">
