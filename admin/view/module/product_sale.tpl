<?php echo $header ?>
    <section class="content">
        ...
        <form action="<?php echo urlLink('module/product_sale'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" id="form-user-group">
                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="product_sale_module[width]" id="input-width" value="<?php echo isset($module['width']) ? $module['width'] : '100'; ?>" class="form-control" placeholder="Chiều rộng"/>
                                    <?php if ($error_width) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="product_sale_module[height]" id="input-width" value="<?php echo isset($module['height']) ? $module['height'] : '100'; ?>" class="form-control" placeholder="Chiều cao"/>
                                    <?php if ($error_height) { ?>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <?php foreach ($layouts as $key => $layout) { ?>
                                            <tr>
                                                ...
                                                <td class="text-left">
                                                    <select name="product_sale_module[layout][<?php echo $layout['code']; ?>][position]" class="form-control">
                                                ...
                                                <td class="text-left">
                                                    <input type="text" name="product_sale_module[layout][<?php echo $layout['code']; ?>][sort_order]" value="<?php echo isset($module['layout']) ? $module['layout'][$layout['code']]['sort_order'] : '1' ?>" class="form-control"/>
                                                </td>
                                                <td class="text-left">
