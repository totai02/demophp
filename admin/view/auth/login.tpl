...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="resources/assets/bower/admin-lte/plugins/iCheck/square/blue.css">
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="<?php echo $action ?>" method="post" enctype="multipart/form-data">
            <?php if($error_waring) { ?>
                <div class="alert alert-danger"><?php echo $error_waring ?></div>
            <?php } ?>
        ...
        <a href="<?php echo $forgot ?>">I forgot my password</a><br>
    </div>
    <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
...
<!-- iCheck -->
<script src="resources/assets/bower/admin-lte/plugins/iCheck/icheck.min.js"></script>
<script>
    $(function () {
        $('input').iCheck({
